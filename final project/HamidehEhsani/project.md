...
plt.show()
```
![](https://github.com/semnan-university-ai/machine-learning-class/blob/main/final%20project/HamidehEhsani/attribute.png)
# KNN Algorithm
```
...
![](https://github.com/semnan-university-ai/machine-learning-class/blob/main/final%20project/HamidehEhsani/knn.png)
