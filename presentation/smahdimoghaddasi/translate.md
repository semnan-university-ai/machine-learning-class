...
شکل ۱. توصیف ویژگی مجموعه داده  [ ۱۲ ]
...
شکل ۳. رسیدگی به توزیع نامتوازن کلاس
...
- در پایگاه داده نامتوازن = ۱۵۴۲۰ (شکل ۹).
...
شکل ۱۰. توزیع کلاس داده ها پس از نمونه برداری مجدد با SMOTE در Weka
...
شکل ۱۵. ماتریس سردرگمی برای مدل پیشنهادی
...
### ۵. تجزیه و تحلیل مقایسه ای  

ما یک تحلیل نسبی و مقایسه ای دقیق بین مدل پیشنهادی خود و دیگر رویکردهای موجود مدل SMOTE - SVM، درخت تصمیم و طبقه بندی کننده های MLP انجام می دهیم. برای تحلیل مقایسه ای نتایج به جدول ۵ مراجعه کنید. 
...
جدول ۵: مقایسه مدل های مختلف با رویکرد پیشنهادی [ ۵ ] 
...
استفاده از روش نمونه برداری مجدد SMOTE برای متوازن کردن توزیع کلاس و سپس اعمال طبقه بندی مربوطه به ما نتایج استثنایی داده است. مدل ما نسبت به سه دسته بندی کننده مختلف تحت نظارت، یعنی ماشین بردار پشتیبان (SVM)، درخت تصمیم گیری و پرسپترون چند لایه (MLP) عملکرد بهتری داشته و دارای حساسیت ۹۹.۹ % می باشد. ساخت مدل ۱.۴۳ ثانیه طول کشید. 
